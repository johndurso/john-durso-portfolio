...
Designer [Michal Malewicz](https://michalmalewicz.medium.com) originally coined the term, which came from a portmanteau: "new," plus "skeuomorphism." From there, the design community ran with it. Tutorials flooded YouTube, CSS snippets spread across CodePen, and design Twitter could not stop talking about it.
